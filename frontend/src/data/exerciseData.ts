...
export const exerciseData: Record<AgeGroup, Record<Goal, string[]>> = {
  criancas: {
    'perder-peso': [
...
export function getLocalExercises(ageGroup: AgeGroup, goal: Goal): string[] {
  return exerciseData[ageGroup]?.[goal] ?? [];
}
